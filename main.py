                    ...
                    if len(list_of_businesses_glob_id) == 0:
                        ...
                        for b in list_of_bus_id:
                            for bi in pv.B_PROFILE:
                                if bi.id == b:
                                    if pv.A_PROFILE[i].IQ <= variables.IQ1_lower:
                                        my_IQ = 1
                                    elif pv.A_PROFILE[i].IQ > variables.IQ1_lower and pv.A_PROFILE[i].IQ <= variables.IQ3_greater:
                                        my_IQ = 2
                                    elif pv.A_PROFILE[i].IQ > variables.IQ3_greater:
                                        my_IQ = 3
                                    if variables.debug is True:
                                        x = pv.RAND_NUM[iteration]
                                    else:
                                    ...
                                    if bi.b_type == 1:
                                        if pv.A_ACTIVITY[i].curr_cap >= variables.B1_ICthr:
                                            if my_IQ == 1:
                                                B1_risc_accept = variables.B1_1
                                            elif my_IQ == 2:
                                                B1_risc_accept = variables.B1_2
                                            elif my_IQ == 3:
                                                B1_risc_accept = variables.B1_3
                                            if x <= B1_risc_accept:
                                                if variables.debug is True:
                                                    x = pv.RAND_NUM[iteration]
                                                else:
                                                    x = random.random()
                                                if x <= variables.B1_p_risc:
                                                    invest_cap = pv.A_ACTIVITY[i].curr_cap * variables.B1_inv_a
                                                    new_cap = pv.A_ACTIVITY[i].curr_cap - invest_cap
                                                    pv.A_ACTIVITY[i].curr_cap = new_cap
                                                    update_A_pos(pv.A_ACTIVITY[i], 0, 0, 1, 1, 0)
                                                    break
                                                else:
                                                    del_cap = pv.A_ACTIVITY[i].curr_cap * variables.B1_ICthr
                                                    invest_cap = pv.A_ACTIVITY[i].curr_cap * variables.B1_inv_a
                                                    new_cap = pv.A_ACTIVITY[i].curr_cap + del_cap - invest_cap
                                                    pv.A_ACTIVITY[i].curr_cap = new_cap
                                        ...
                                        if pv.A_ACTIVITY[i].curr_cap >= variables.B2_ICthr:
                                            if my_IQ == 1:
                                                B2_risc_accept = variables.B2_1
                                            elif my_IQ == 2:
                                                B2_risc_accept = variables.B2_2
                                            elif my_IQ == 3:
                                                B2_risc_accept = variables.B2_3
                                            if x <= B2_risc_accept:
                                                if variables.debug is True:
                                                    x = pv.RAND_NUM[iteration]
                                                else:
                                                    x = random.random()
                                                if x <= variables.B2_p_risc:
                                                    invest_cap = pv.A_ACTIVITY[i].curr_cap * variables.B2_inv_a
                                                    new_cap = pv.A_ACTIVITY[i].curr_cap - invest_cap
                                                    pv.A_ACTIVITY[i].curr_cap = new_cap
                                                    update_A_pos(pv.A_ACTIVITY[i], 0, 0, 1, 1, 0)
                                                    break
                                                else:
                                                    del_cap = pv.A_ACTIVITY[i].curr_cap * variables.B2_ICthr
                                                    invest_cap = pv.A_ACTIVITY[i].curr_cap * variables.B2_inv_a
                                                    new_cap = pv.A_ACTIVITY[i].curr_cap + del_cap - invest_cap
                                                    pv.A_ACTIVITY[i].curr_cap = new_cap
                                                    update_A_pos(pv.A_ACTIVITY[i], 1, 1, 0, 0, 0)
                                        ...
                                        if pv.A_ACTIVITY[i].curr_cap >= variables.B3_ICthr:
                                            if my_IQ == 1:
                                                B3_risc_accept = variables.B3_1
                                            elif my_IQ == 2:
                                                B3_risc_accept = variables.B3_2
                                            elif my_IQ == 3:
                                                B3_risc_accept = variables.B3_3
                                            if x <= B3_risc_accept:
                                                if variables.debug is True:
                                                    x = pv.RAND_NUM[iteration]
                                                else:
                                                ...
                                                if x <= variables.B3_p_risc:
                                                    invest_cap = pv.A_ACTIVITY[i].curr_cap * variables.B3_inv_a
                                                    new_cap = pv.A_ACTIVITY[i].curr_cap - invest_cap
                                                    pv.A_ACTIVITY[i].curr_cap = new_cap
                                                    update_A_pos(pv.A_ACTIVITY[i], 0, 0, 1, 1, 0)
                                                    break
                                                else:
                                                    del_cap = pv.A_ACTIVITY[i].curr_cap * variables.B3_ICthr
                                                    invest_cap = pv.A_ACTIVITY[i].curr_cap * variables.B3_inv_a
                                                    new_cap = pv.A_ACTIVITY[i].curr_cap + del_cap - invest_cap
                                                    pv.A_ACTIVITY[i].curr_cap = new_cap
                                                    update_A_pos(pv.A_ACTIVITY[i], 1, 1, 0, 0, 0)
